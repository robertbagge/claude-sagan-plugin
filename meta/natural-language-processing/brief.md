...
**Output dir**: `meta/natural-language-processing/`
**Created**: 2026-05-01
...
- Each topic is researched by a parallel agent and saved to `meta/natural-language-processing/research/{topic-slug}.md`.
- Each topic agent's primary mode is external web research — fresh sources, not training data.
- The whole-corpus synthesis lives at `meta/natural-language-processing/synthesis/general.md` and is fully rewritten after each round. Other files in `meta/natural-language-processing/synthesis/` are topic-specific syntheses across the same corpus.
...
File: `research/statistical-nlp.md`
...
File: `research/foundational-ml-discoveries.md`
...
File: `research/word-embeddings.md`
...
File: `research/sequence-models.md`
...
File: `research/transformer-revolution.md`
...
File: `research/rlhf-alignment.md`
...
File: `research/multimodal-agentic.md`
...
File: `research/open-weights-ecosystem.md`
...
File: `research/popularisation.md`
...
File: `research/frontier-directions.md`
...
File: `research/mechanistic-interpretability.md`
...
File: `research/long-context-memory.md`
...
File: `research/pretraining-data.md`
...
File: `research/inference-infrastructure.md`
...
File: `research/speech-and-text.md`
...
File: `research/red-teaming-jailbreaks.md`
