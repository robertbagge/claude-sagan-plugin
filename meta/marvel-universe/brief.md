...
**Output dir**: `meta/marvel-universe/`
**Created**: 2026-05-01
...
- Each topic is researched by a parallel agent and saved to `meta/marvel-universe/research/{topic-slug}.md`.
- Each topic agent's primary mode is external web research — fresh sources, not training data.
- The whole-corpus synthesis lives at `meta/marvel-universe/synthesis/general.md` and is fully rewritten after each round. Other files in `meta/marvel-universe/synthesis/` are topic-specific syntheses across the same corpus.
...
File: `research/multiverse-cosmology.md`
...
File: `research/major-continuities.md`
...
File: `research/cosmic-hierarchy.md`
...
File: `research/teams-factions.md`
...
File: `research/species-races.md`
...
File: `research/earth-616-geography.md`
...
File: `research/magic-mystic-dimensions.md`
...
File: `research/crossover-events.md`
...
File: `research/mcu-phases-multiverse-saga.md`
...
File: `research/power-scaling-classification.md`
...
File: `research/reality-altering-artifacts.md`
...
File: `research/time-travel-mechanics.md`
...
File: `research/cosmic-empires.md`
...
File: `research/knull-symbiote-cosmology.md`
...
File: `research/weapons-cosmic-war.md`
...
File: `research/ai-cybernetic-entities.md`
...
File: `research/demographics-populations.md`
...
File: `research/corporations-industry.md`
